...
webDB.setupTables = function () {
  html5sql.process(
    'CREATE TABLE IF NOT EXISTS articles (id INTEGER PRIMARY KEY, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, authorUrl VAR (255), category VARCHAR(20) NOT NULL, publishedOn DATETIME, markdown TEXT NOT NULL);',
    function() {
      // on success
